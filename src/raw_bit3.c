...
static const int bp4_size = sizeof(bp4) / sizeof(struct Bitplane);

static const struct Bitplane bp2[] = {
...
static const int bp2_size = sizeof(bp2) / sizeof(struct Bitplane);
