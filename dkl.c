...
void dkl_levels(uint8_t *rom, char *dir, uint8_t sgb) {
    ...
    uint8_t *raw_data = calloc(0x1000, 1);
    int rawlen = 0;
    int t_width, t_height;
    char name[255];
    
    struct dkl_levels dkl[] = {
        {0x00, 0x7C, {0x82, 0x01, 0x03}, {0x0D, 0x48, 0x1D}, 0xE936, "1-1 Jungle Jaunt"},
        {0x1A, 0x0F, {0x00, 0x01, 0x03}, {0x0D, 0x7F, 0x3B}, 0xE966, "1-1 Jungle Jaunt B1"},
        {0x18, 0x0E, {0x80, 0x07, 0x03}, {0x07, 0x4D, 0x85}, 0xE9DE, "1-1 Jungle Jaunt B2"},
        {0x06, 0xD4, {0x00, 0x07, 0x02}, {0x0D, 0x40, 0xDF}, 0xE92E, "1-2 Freezing Fun"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE92E, "1-2 Freezing Fun B1"},
        {0x00, 0x91, {0x82, 0x01, 0x03}, {0x0D, 0x4A, 0xFC}, 0xE976, "1-3 Simian Swing"},
        {0x1A, 0x09, {0x00, 0x01, 0x03}, {0x0D, 0x7E, 0xD1}, 0xE956, "1-3 Simian Swing B1"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE9A6, "1-3 Simian Swing B2"},
        {0x0E, 0x10, {0x00, 0x07, 0x01}, {0x0D, 0x63, 0xAB}, 0xE986, "1-4 Deck Trek"},
        {0x1C, 0x08, {0x00, 0x07, 0x03}, {0x11, 0x7F, 0xA0}, 0xE9AE, "1-4 Deck Trek B1"},
        {0x00, 0x0F, {0x82, 0x01, 0x03}, {0x0E, 0x7F, 0x79}, 0xE93E, "1-4 Deck Trek B2"},
        {0x06, 0xB5, {0x00, 0x07, 0x02}, {0x0D, 0x44, 0xDB}, 0xE97E, "1-5 Rope Ravine"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE9AE, "1-5 Rope Ravine B1"},
        {0x18, 0x0E, {0x80, 0x07, 0x03}, {0x07, 0x4D, 0x3D}, 0xE9E6, "1-5 Rope Ravine B2"},
        {0x00, 0x8E, {0x82, 0x01, 0x03}, {0x0D, 0x4E, 0x38}, 0xE996, "1-6 Tyre Trail"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE9A6, "1-6 Tyre Trail B1"},
        {0x1A, 0x05, {0x00, 0x01, 0x03}, {0x0D, 0x7E, 0xB5}, 0xE94E, "1-6 Tyre Trail B2"},
        {0x1A, 0x0F, {0x00, 0x01, 0x03}, {0x0D, 0x7E, 0xFF}, 0xE95E, "1-6 Tyre Trail B3"},
        {0x0E, 0xFA, {0x00, 0x07, 0x01}, {0x0D, 0x5E, 0x39}, 0xE956, "1-7 Riggin' Rumble"},
        {0x17, 0x0A, {0xB4, 0x07, 0x03}, {0x09, 0x7F, 0xD1}, 0xE92E, "1-7 Riggin' Rumble B1"},
        {0x00, 0x0D, {0x82, 0x01, 0x03}, {0x0E, 0x7F, 0xB3}, 0xE946, "1-7 Riggin' Rumble B2"},
        {0x00, 0x98, {0x82, 0x01, 0x03}, {0x0D, 0x51, 0xE3}, 0xE93E, "1-8 Congo Carnage"},
        {0x0E, 0x07, {0x00, 0x07, 0x01}, {0x06, 0x7E, 0x79}, 0xE96E, "1-8 Congo Carnage B1"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE9AE, "1-8 Congo Carnage B2"},
        {0x06, 0xAE, {0x00, 0x07, 0x02}, {0x0E, 0x76, 0xF8}, 0xE9EE, "1-9 Arctic Barrel Arsenal"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE996, "1-9 Arctic Barrel Arsenal B1"},
        {0x1C, 0x0B, {0x00, 0x07, 0x03}, {0x11, 0x7F, 0xC5}, 0xE9A6, "1-9 Arctic Barrel Arsenal B2"},
        {0x0E, 0x05, {0x00, 0x07, 0x01}, {0x0D, 0x7F, 0xDC}, 0xE97E, "1-B Wild Sting Fling"},
        {0x0A, 0xB8, {0x46, 0x07, 0x02}, {0x0D, 0x55, 0x21}, 0xE946, "2-1 Tricky Temple"},
        {0x1C, 0x29, {0x00, 0x07, 0x03}, {0x06, 0x7E, 0xC5}, 0xE98E, "2-1 Tricky Temple B1"},
        {0x18, 0xB6, {0x80, 0x07, 0x03}, {0x0D, 0x7B, 0x27}, 0xE9AE, "2-2 Kremlantis"},
        {0x0C, 0x35, {0x45, 0x07, 0x01}, {0x0D, 0x65, 0xC9}, 0xE94E, "2-3 Reef Rampage"},
        {0x0A, 0xC8, {0x46, 0x07, 0x02}, {0x0D, 0x58, 0x36}, 0xE966, "2-4 Snake Charmer's Challenge"},
        {0x1D, 0x22, {0x87, 0x07, 0x01}, {0x07, 0x4D, 0xC8}, 0xE9CE, "2-4 Snake Charmer's Challenge B1"},
        {0x18, 0x8A, {0x80, 0x07, 0x03}, {0x06, 0x76, 0xC2}, 0xEA16, "2-5 Chomp's Coliseum"},
        {0x0C, 0x3E, {0x45, 0x07, 0x01}, {0x0D, 0x6C, 0x5E}, 0xE95E, "2-6 Nautilus Chase"},
        {0x0A, 0xB3, {0x46, 0x07, 0x02}, {0x0D, 0x5B, 0x4B}, 0xE96E, "2-7 Swirlwind Storm"},
        {0x1C, 0x1D, {0x00, 0x07, 0x03}, {0x06, 0x7F, 0x6C}, 0xE996, "2-7 Swirlwind Storm B1"},
        {0x18, 0x05, {0x80, 0x07, 0x03}, {0x0E, 0x7F, 0xED}, 0xE9FE, "2-B Seabed Showdown"},
        {0x1A, 0xAC, {0x00, 0x01, 0x03}, {0x0E, 0x56, 0xEF}, 0xE9BE, "3-1 Pot Hole Panic"},
        {0x17, 0x19, {0xB4, 0x07, 0x03}, {0x0B, 0x7F, 0x26}, 0xEA0E, "3-1 Pot Hole Panic B1"},
        {0x0E, 0x05, {0x00, 0x07, 0x01}, {0x0D, 0x7F, 0xDC}, 0xE94E, "3-1 Pot Hole Panic B2"},
        {0x1B, 0x29, {0x5E, 0x01, 0x03}, {0x0E, 0x5B, 0x6D}, 0xE9C6, "3-2 Mountain Mayhem"},
        {0x0E, 0x20, {0x00, 0x07, 0x01}, {0x0D, 0x7F, 0x80}, 0xE976, "3-2 Mountain Mayhem B1"},
        {0x17, 0x05, {0xB4, 0x07, 0x03}, {0x07, 0x4C, 0xD7}, 0xE966, "3-2 Mountain Mayhem B2"},
        {0x1D, 0x8B, {0x87, 0x07, 0x01}, {0x0E, 0x67, 0xF6}, 0xE9DE, "3-3 Track Attack"},
        {0x1A, 0x05, {0x00, 0x01, 0x03}, {0x0D, 0x7E, 0xB5}, 0xE946, "3-3 Track Attack B1"},
        {0x17, 0x05, {0xB4, 0x07, 0x03}, {0x07, 0x4C, 0xD7}, 0xEA16, "3-3 Track Attack B2"},
        {0x1A, 0xAF, {0x00, 0x01, 0x03}, {0x06, 0x79, 0x1E}, 0xEA26, "3-4 Spiky Tyre Trail"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE93E, "3-4 Spiky Tyre Trail B1"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE98E, "3-4 Spiky Tyre Trail B2"},
        {0x1D, 0x30, {0x87, 0x07, 0x01}, {0x0E, 0x6B, 0xE4}, 0xE9E6, "3-5 Sky High Caper"},
        {0x18, 0x20, {0x80, 0x07, 0x03}, {0x09, 0x7F, 0x66}, 0xE9F6, "3-5 Sky High Caper B1"},
        {0x1B, 0xC6, {0x5E, 0x01, 0x03}, {0x09, 0x7A, 0x88}, 0xEA0E, "3-6 Landslide Leap"},
        {0x1A, 0x0F, {0x00, 0x01, 0x03}, {0x0D, 0x7E, 0xFF}, 0xE996, "3-6 Landslide Leap B1"},
        {0x17, 0x11, {0xB4, 0x07, 0x03}, {0x0B, 0x7F, 0x80}, 0xEA1E, "3-6 Landslide Leap B2"},
        {0x1D, 0xBD, {0x87, 0x07, 0x01}, {0x0E, 0x71, 0xBD}, 0xE9FE, "3-7 Collapsing Clouds"},
        {0x17, 0x09, {0xB4, 0x07, 0x03}, {0x0B, 0x7F, 0x03}, 0xE976, "3-7 Collapsing Clouds B1"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE9AE, "3-7 Collapsing Clouds B2"},
        {0x1A, 0x05, {0x00, 0x01, 0x03}, {0x07, 0x4E, 0x9C}, 0xEA2E, "3-B Mad Mole Holes"},
        {0x19, 0x9B, {0x95, 0x07, 0x02}, {0x0E, 0x40, 0x01}, 0xE9B6, "4-1 Construction Site Fight"},
        {0x1D, 0x15, {0x87, 0x07, 0x01}, {0x07, 0x4F, 0x86}, 0xE9B6, "4-1 Construction Site Fight B1"},
        {0x1D, 0x24, {0x87, 0x07, 0x01}, {0x07, 0x4E, 0xB6}, 0xE9D6, "4-1 Construction Site Fight B2"},
        {0x17, 0xBD, {0xB4, 0x07, 0x03}, {0x0D, 0x76, 0xBE}, 0xE9A6, "4-2 Kong Krazy"},
        {0x1C, 0x08, {0x00, 0x07, 0x03}, {0x11, 0x7F, 0xA0}, 0xE956, "4-2 Kong Krazy B1"},
        {0x1C, 0x9C, {0x00, 0x07, 0x03}, {0x0E, 0x5F, 0x8A}, 0xE9D6, "4-3 Balloon Barrage"},
        {0x17, 0x0A, {0xB4, 0x07, 0x03}, {0x09, 0x7F, 0xD1}, 0xE96E, "4-3 Balloon Barrage B1"},
        {0x17, 0x0C, {0xB4, 0x07, 0x03}, {0x0B, 0x7F, 0xB3}, 0xE936, "4-3 Balloon Barrage B2"},
        {0x17, 0xB3, {0xB4, 0x07, 0x03}, {0x0E, 0x7A, 0x45}, 0xE9F6, "4-4 Fast Barrel Blast"},
        {0x00, 0x05, {0x82, 0x01, 0x03}, {0x06, 0x7E, 0x5E}, 0xE9A6, "4-4 Fast Barrel Blast B1"},
        {0x00, 0x0A, {0x82, 0x01, 0x03}, {0x0E, 0x7F, 0x47}, 0xE936, "4-4 Fast Barrel Blast B2"},
        {0x19, 0xC9, {0x95, 0x07, 0x02}, {0x0E, 0x45, 0xFB}, 0xE9CE, "4-5 Skyscraper Caper"},
        {0x18, 0x05, {0x80, 0x07, 0x03}, {0x0E, 0x7F, 0xED}, 0xE95E, "4-5 Skyscraper Caper B1"},
        {0x1C, 0x8E, {0x00, 0x07, 0x03}, {0x0E, 0x64, 0x17}, 0xEA1E, "4-6 Button Barrel Blast"},
        {0x1A, 0x09, {0x00, 0x01, 0x03}, {0x0D, 0x7E, 0xD1}, 0xE98E, "4-6 Button Barrel Blast B1"},
        {0x00, 0x0A, {0x82, 0x01, 0x03}, {0x0E, 0x7F, 0x47}, 0xE98E, "4-6 Button Barrel Blast B2"},
        {0x19, 0x29, {0x95, 0x07, 0x02}, {0x0E, 0x4F, 0x08}, 0xEA06, "4-7 Oil Drum Slum"},
        {0x18, 0x26, {0x80, 0x07, 0x03}, {0x07, 0x4C, 0xEA}, 0xE9EE, "4-7 Oil Drum Slum B1"},
        {0x0E, 0x07, {0x00, 0x07, 0x01}, {0x06, 0x7E, 0x79}, 0xE97E, "4-7 Oil Drum Slum B2"},
        {0x17, 0x09, {0xB4, 0x07, 0x03}, {0x0B, 0x7F, 0x03}, 0xEA06, "4-B K. Rool's Kingdom"}
    };
    ...
    for (i = 0; i < size; i++) {
        ...
        dkl_raw(rom, raw_data, &rawlen, dkl[i].raw[0], dkl[i].raw[1], dkl[i].raw[2]); // DECOMPRESS RAW DATA
        
        t_width  = dkl[i].t_width;
        t_height = rawlen / dkl[i].t_width;
        
        dkl_tiles(rom, bp_data, &bp_len, dkl[i].bp_val); // DECOMPRESS BP DATA
        memmove(&bp_data[0], &bp_data[0x1000], 0x800);
        
        if (dkl[i].lay[0] == 0x95) {
            memcpy(&bp_data[0x1000], &bp_data[0x1C0], 16);
            memcpy(&bp_data[0x1C0], &bp_data[0x1D0], 16);
            memcpy(&bp_data[0x1D0], &bp_data[0x1000], 16); // Skyscraper Rope Fix
        }
        
        bank = ((dkl[i].lay[1] * 0x4000) + (dkl[i].lay[2] * 0x1000));
        
        dkl_layout(rom, raw_data, lay_data, dkl[i].lay[0], bank, t_width, t_height); // DECODE 8x8 FULL LAYOUT
...
void dkl2_levels(uint8_t *rom, char *dir, uint8_t sgb) {
    ...
    struct dkl2_arches arch[] = {
        ...
        { {0x12, 0x4A, 0xE8, 0xDB}, {0x3D, 0x11, 0x03}, {0xFF, 0x3A, 0xB8, 0x11, 0xF0, 0x08, 0x00, 0x00} }, // Ship Deck
        { {0x12, 0x40, 0x02, 0xE0}, {0xAE, 0x11, 0x02}, {0x53, 0x7F, 0x10, 0x42, 0xCE, 0x10, 0x00, 0x00} }, // Ship Mast
        { {0x14, 0x55, 0x12, 0xE0}, {0xA2, 0x11, 0x00}, {0x4F, 0x7F, 0x0D, 0x42, 0xCC, 0x00, 0x00, 0x00} }, // Ship Hold
        { {0x13, 0x60, 0xB8, 0xDD}, {0x70, 0x11, 0x01}, {0x5F, 0x33, 0x7E, 0x02, 0x92, 0x10, 0x00, 0x00} }, // Lava
        { {0x12, 0x54, 0x4A, 0xCA}, {0x67, 0x11, 0x00}, {0x76, 0x22, 0x71, 0x01, 0xAC, 0x00, 0x00, 0x00} }, // Mine
        { {0x13, 0x6A, 0x2C, 0xE2}, {0xAF, 0x11, 0x03}, {0x9A, 0x03, 0x50, 0x02, 0x0B, 0x01, 0x00, 0x00} }, // Swamp
        { {0x14, 0x4A, 0xBD, 0xE1}, {0x00, 0x11, 0x01}, {0x5F, 0x03, 0x19, 0x02, 0xF3, 0x00, 0x00, 0x00} }, // Hive
        { {0x13, 0x55, 0xA1, 0xE2}, {0x57, 0x11, 0x02}, {0xBF, 0x5B, 0x58, 0x32, 0xAD, 0x00, 0x00, 0x00} }, // Fair
        { {0x13, 0x40, 0x02, 0xE0}, {0x00, 0x14, 0x02}, {0x76, 0x22, 0x48, 0x02, 0x64, 0x01, 0x00, 0x00} }, // Brambles
        { {0x12, 0x5E, 0x6B, 0xDF}, {0x00, 0x11, 0x00}, {0x76, 0x22, 0x90, 0x01, 0xAE, 0x00, 0x00, 0x00} }, // Forest
        { {0x13, 0x4B, 0x68, 0xE0}, {0x00, 0x11, 0x03}, {0x7B, 0x77, 0xF1, 0x72, 0x80, 0x65, 0x00, 0x00} }, // Ice
        { {0x14, 0x40, 0x02, 0xE1}, {0x32, 0x14, 0x02}, {0x78, 0x7F, 0x31, 0x4A, 0x10, 0x01, 0x00, 0x00} }, // Castle
        { {0x12, 0x68, 0xAE, 0xCE}, {0x00, 0x11, 0x02}, {0x58, 0x03, 0x91, 0x02, 0x8C, 0x01, 0x00, 0x00} }, // Jungle
    };
    /*
    struct dkl2_arches arch[] = {
        //  3A66 ROM,  HL/SP, A      2FC9 DBD0, ROM & H
        { {0x12, 0x4A, 0xE8, 0xDB}, {0x3D, 0x11, 0x03}, {0xFF, 0x3A, 0xB8, 0x11, 0xF0, 0x08, 0x00, 0x00} }, // Ship Deck
        { {0x12, 0x40, 0x02, 0xE0}, {0xAE, 0x11, 0x02}, {0x53, 0x7F, 0x10, 0x42, 0xCE, 0x10, 0x00, 0x00} }, // Ship Mast
        { {0x14, 0x55, 0x14, 0xE0}, {0xA2, 0x11, 0x00}, {0x4F, 0x7F, 0x0D, 0x42, 0xCC, 0x00, 0x00, 0x00} }, // Ship Hold
        { {0x13, 0x60, 0xBA, 0xDD}, {0x70, 0x11, 0x01}, {0x5F, 0x33, 0x7E, 0x02, 0x92, 0x10, 0x00, 0x00} }, // Lava
        { {0x12, 0x54, 0x4B, 0xCA}, {0x67, 0x11, 0x00}, {0x76, 0x22, 0x71, 0x01, 0xAC, 0x00, 0x00, 0x00} }, // Mine
        { {0x13, 0x6A, 0x2E, 0xE2}, {0xAF, 0x11, 0x03}, {0x9A, 0x03, 0x50, 0x02, 0x0B, 0x01, 0x00, 0x00} }, // Swamp
        { {0x14, 0x4A, 0xBE, 0xE1}, {0x00, 0x11, 0x01}, {0x5F, 0x03, 0x19, 0x02, 0xF3, 0x00, 0x00, 0x00} }, // Hive
        { {0x13, 0x55, 0xA2, 0xE2}, {0x57, 0x11, 0x02}, {0xBF, 0x5B, 0x58, 0x32, 0xAD, 0x00, 0x00, 0x00} }, // Fair
        { {0x13, 0x40, 0x02, 0xE0}, {0x00, 0x14, 0x03}, {0x76, 0x22, 0x48, 0x02, 0x64, 0x01, 0x00, 0x00} }, // Brambles
        { {0x12, 0x5E, 0x6C, 0xDF}, {0x00, 0x11, 0x00}, {0x76, 0x22, 0x90, 0x01, 0xAE, 0x00, 0x00, 0x00} }, // Forest
        { {0x13, 0x4B, 0x68, 0xE0}, {0x00, 0x11, 0x03}, {0x7B, 0x77, 0xF1, 0x72, 0x80, 0x65, 0x00, 0x00} }, // Ice
        { {0x14, 0x40, 0x02, 0xE1}, {0x32, 0x14, 0x03}, {0x78, 0x7F, 0x31, 0x4A, 0x10, 0x01, 0x00, 0x00} }, // Castle
        { {0x12, 0x68, 0xB0, 0xCE}, {0x00, 0x11, 0x02}, {0x58, 0x03, 0x91, 0x02, 0x8C, 0x01, 0x00, 0x00} }, // Jungle
    }; // Japanese Version
    */
    ...
    for (i = 0; i < size; i++) {
        ...
        dkl2_tiles(rom, bp_data, &bp_len, arch[dkl[i].arch].bp_bank[0], ((arch[dkl[i].arch].bp_bank[1]-0x40)*256)+arch[dkl[i].arch].bp_bank[2], arch[dkl[i].arch].bp_bank[3]); // DECOMPRESS BP DATA
        
        bank = ((arch[dkl[i].arch].lay[1] * 0x4000) + (arch[dkl[i].arch].lay[2] * 0x1000));
        
        dkl_layout(rom, raw_data, lay_data, arch[dkl[i].arch].lay[0], bank, t_width, t_height); // DECODE 8x8 FULL LAYOUT
        
        if (sgb == 5) {
            decode_palette(rgb, &bw[0], 4);
        }
        else {
            decode_palette(rgb, &arch[dkl[i].arch].pal[0], 4);
        }
...
void dkl3_levels(uint8_t *rom, char *dir, uint8_t sgb) {
    ...
    struct dkl3_arches arch[] = {
        //  3A67 ROM,  HL/SP, A      3020 DBD0, ROM & H
        { {0x12, 0x5C, 0xB1, 0xE0}, {0x00, 0x11, 0x00} }, // Boardwalk
        { {0x12, 0x66, 0x73, 0xE2}, {0x5F, 0x15, 0x00} }, // Underwater
        { {0x12, 0x40, 0x02, 0xB1}, {0x00, 0x11, 0x03} }, // Mill
        { {0x13, 0x61, 0xAA, 0xDA}, {0x00, 0x11, 0x01} }, // Riverside
        { {0x13, 0x6C, 0x8C, 0xDD}, {0x7F, 0x11, 0x00} }, // Tree
        { {0x12, 0x47, 0x96, 0xE0}, {0x6D, 0x11, 0x03} }, // Snow
        { {0x13, 0x40, 0x02, 0xD7}, {0x00, 0x11, 0x02} }, // Waterfall
        { {0x13, 0x4B, 0xDF, 0xE0}, {0x4C, 0x11, 0x02} }, // Cliff
        { {0x12, 0x72, 0x51, 0xDA}, {0x6A, 0x11, 0x01} }, // Jungle
        { {0x13, 0x57, 0x88, 0xDB}, {0x00, 0x15, 0x00} }, // Le Factoire
        { {0x13, 0x77, 0x46, 0xE0}, {0x91, 0x15, 0x00} }, // Pipe
        { {0x12, 0x51, 0x5A, 0xDE}, {0x9B, 0x11, 0x02} }, // Cave
    }; // 
