...
void spec1(uint8_t *rom, char dir[255]) {
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "DKC Overworld.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Kongo Jungle (Left).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Kongo Jungle (Right).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Monkey Mines (Left).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Monkey Mines (Right).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Vine Valley (Left).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Vine Valley (Right).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Gorilla Glacier (Left).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Gorilla Glacier (Right).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Kremkroc Industries Inc (Left).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Kremkroc Industries Inc (Right).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Chimp Caverns (Left).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Chimp Caverns (Right).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Candy's Save Point.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Cranky's Cabin BG1.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Cranky's Cabin BG2.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Mode Screen BG.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "File Screen BG3.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Nintendo 1994.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "DK's Treehouse.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Cave FG3.png");
    decode_bitplane(rom, bp_data, raw_data, bitplane, 0x39AD65, raw_counter, bp_counter, 3, 0, 0);
    assemble_screen(bitplane, raw_counter, 32, dir, "Cave FG3 (Alt).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Water BG2.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Walkway BG2 (Left).png");
    
    raw_counter = 0x800;
    memcpy(raw_data, &rom[0x28922A], raw_counter);
    decode_bitplane(rom, bp_data, raw_data, bitplane, 0x39A2DC, raw_counter, bp_counter, 2, 0, 0);
    assemble_screen(bitplane, raw_counter, 32, dir, "Walkway BG2 (Right).png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Mine Cart Carnage BG3.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Temple BG3.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Oil Drum Alley BG3.png");
    decode_bitplane(rom, bp_data, raw_data, bitplane, 0x39B0A3, raw_counter, bp_counter, 3, 63, 1);
    assemble_screen(bitplane, raw_counter, 32, dir, "Blackout Basement BG3.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Forest BG3.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Tree Top Town BG2.png");
    decode_bitplane(rom, bp_data, raw_data, bitplane, 0x39B1A3, raw_counter, bp_counter, 2, 0, 0);
    assemble_screen(bitplane, raw_counter, 32, dir, "Rope Bridge Rumble BG2.png");
    ...
    assemble_screen(bitplane, raw_counter, 32, dir, "Tree Top Town BG3.png");
    decode_bitplane(rom, bp_data, raw_data, bitplane, 0x39B1A3, raw_counter, bp_counter, 3, 0, 1);
    assemble_screen(bitplane, raw_counter, 32, dir, "Rope Bridge Rumble BG3.png");
